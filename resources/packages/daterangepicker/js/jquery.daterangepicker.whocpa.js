...
(function($) {
	...
	$.dateRangePickerLanguages = {
		'cn':    {
			...
			'week-6':          'SA',
			'week-7':          'SU',
			'month-name':      ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'ธันวาคม'],
			'shortcuts':       'ทางลัด',
			'past':            'อดีต',
			...
			'next-month':      'เดือน',
			'next-year':       'ปี',
			'less-than':       'ช่วงวันที่ไม่ควรเกิน %d วัน',
			'more-than':       'ช่วงวันที่ไม่ควรน้อยกว่า %d วัน',
			'default-more':    'โปรดเลือกช่วงวันที่นานกว่า %d วัน',
			'default-single':  'กรุณาเลือกวันที่',
			'default-less':    'โปรดเลือกช่วงวันที่น้อยกว่า %d วัน',
			'default-range':   'โปรดเลือกช่วงวันที่ระหว่าง %d และ %d วัน',
			'default-default': 'โปรดเลือกช่วงวันที่'
		},'ru': {
			'selected':        'Период:',
			'day':             'День',
			'days':            'Дней',
	...
	$.fn.dateRangePicker = function(opt) {
		...
		function calcPosition() {
			if (!opt.inline) {
				...
				var input_width = inputname.outerWidth(true) + inputname.prev('label').outerWidth(true) + 10;
